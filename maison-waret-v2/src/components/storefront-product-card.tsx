...
export function StorefrontProductCard({
  ...
  return (
    <article className="overflow-hidden rounded-[30px] border border-[#ead8cc] bg-white shadow-[0_14px_32px_rgba(92,50,28,0.08)] transition hover:-translate-y-1">
      ...
      <div className="p-6">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
          ...
          <AddToOrderButton
            ...
            className="rounded-full border border-[#ead8cc] bg-white px-4 py-2.5 text-sm font-semibold text-[#6d5a50] hover:-translate-y-0.5 hover:border-[#9d5c3f] hover:text-[#9d5c3f] disabled:opacity-60"
          />
        </div>
      </div>
    </article>
